...
const Home = () => {
  return (
    ...
    >
      <h1 id="home-header">Why Call Eddie?</h1>
      <div>
        <div className="reason-box1">
          <p>
            <strong>Remote Diagnostic:</strong> Using the video chat feature on
            our app, a professional will asses your repair and let you know if
            you need to do anything before your technician shows up.
          </p>
        </div>
        <div className="reason-box2">
          <p>
            <strong>Transparency:</strong> Because of the remote diagnostic, we
            can give an accurate estimate of the time and money it will take to
            fix it BEFORE coming to your house.
          </p>
        </div>
        <div className="reason-box1">
          <p>
            <strong>Efficiency:</strong> Knowing what the issue is and how long
            it will take before dispatching a technician ensures we have the
            right parts when we show up the first time, not next week on a
            follow-up visit.
          </p>
        </div>
        <div className="reason-box2">
